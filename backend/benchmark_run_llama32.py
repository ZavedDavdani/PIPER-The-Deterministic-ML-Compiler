...
benchmark_planning_models.py / benchmark_run_qwen35.py, which this
reuses unmodified).

Runs the exact same methodology as the qwen3:4b/qwen3.5:4b benchmarks,
scoped to ONLY llama3.2:3b. Neither qwen model is re-benchmarked.
